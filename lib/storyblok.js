...
/**
 * Safely resolves a Storyblok link which can be either a string or a multilink object.
 */
export function formatStoryblokLink(link, fallback = "/") {
  ...
  if (typeof link === "object") {
    const target = link.cached_url || link.url || "";
