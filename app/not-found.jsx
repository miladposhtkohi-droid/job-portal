  ...
  return (
    <main className="min-h-[70vh] flex items-center justify-center px-4">
      <div className="portal-card p-10 sm:p-14 text-center max-w-lg mx-auto">
        <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-600 dark:text-emerald-400 text-2xl font-bold">
          404
        </div>
        <h1 className="text-3xl font-extrabold text-slate-950 dark:text-white mb-3">
